 ...
 */
class paymentimportbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "paymentimport@paymentimport";
    public $boxlabel;
    public $depends = array("paymentimport");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/paymentimport/class/paymentimport.class.php";
